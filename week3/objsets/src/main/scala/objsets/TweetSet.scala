...
object GoogleVsApple {
  ...
  val googleTweets: TweetSet = TweetReader.allTweets.filter((x:Tweet) => x.text.contains("google"))

  val appleTweets: TweetSet = TweetReader.allTweets.filter((x:Tweet) => x.text.contains("apple"))
